...
The module provides the capability to programmatically manage files and folders in the drive.
...
select the required Google Drive scopes, and then click **Authorize APIs**.
...
### [You can find more samples here](https://github.com/ballerina-platform/module-ballerinax-googleapis.drive/tree/main/drive/samples)
